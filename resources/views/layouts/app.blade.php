...
<head>
    ...
    <link href="{{ asset('/../css/main.css?ver=1.2') }}" rel="stylesheet">
    ...
    <script type="text/javascript" src="//platform-api.sharethis.com/js/sharethis.js#property=5a7b56c2537319001288818f&product=sticky-share-buttons"></script>
    <script>
