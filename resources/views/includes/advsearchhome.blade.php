<div id="filter-panel-home" class="filter-panel"><!-- height 300px -->
  <form action="{{url('/properties')}}" method="GET" role="form">
      ...
      <div style="display: block; width: 570px; max-width: 100%; margin: 0 auto 11px; position: relative;">
        <input type="text" class="form-control input-lg" id="pref-search" name="addr" placeholder="Anywhere">
